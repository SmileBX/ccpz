<template>
  <div class="pageContent">
    <div class="pall bg_fff borderTop">
        ...
        <textarea name="" id="aaa" style="height:200rpx!important;width:100%!important;border:1px solid red" cols="10" rows="2" maxlength="100" placeholder="请输入个人简介" v-model="WorkIdea"></textarea>
    </div>
    <!--个人信息空-->
