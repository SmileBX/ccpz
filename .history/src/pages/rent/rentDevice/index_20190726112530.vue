        ...
        <div class="form-cells">
          ...
          <div class="form-cells-item">
            ...
            <!-- <div class="form-cells-navigate navigate-right"> -->
              ...
              <div class="form-cell-bd">
                <p class="ipt" style="height:200rpx!important;padding:30rpx" v-if="showp" @tap="showp=false" :class="Synopsis.length>0?'colorBlack':'colorPlace'">{{Synopsis ||  '描述细节能够更加吸引优质的候选人哦！'}}</p>
                <textarea
                  v-else
                  class="ipt"
                  type="text"
