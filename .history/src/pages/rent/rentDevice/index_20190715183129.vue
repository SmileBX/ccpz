        ...
        if(res.code==0){
          ...
          if(res.data.arealist.length>0){
            ...
            console.log(this.addressList )
            {
              ...
              console.log(_list.slice(0,10))
              console.log(this.addressList2)
              console.log(this.addressList2[Object.keys(this.addressList2)[0]][Object.keys(this.addressList2[Object.keys(this.addressList2)[0]])[0]],"this.addressList2////")
