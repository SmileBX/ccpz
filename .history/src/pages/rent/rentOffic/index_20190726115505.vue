        ...
        <div class="form-cells">
          ...
          <div class="form-cells-item" v-if="PageId==42 || PageId==41 || PageId==38 || PageId==37 || PageId==39 || PageId==40">
            <div class="">
              ...
              <div class="form-cell-bd">
                <p class="ipt" style="height:200rpx!important;padding:0rpx" v-if="showPP" @tap="showPP=false" :class="ContentDetail.length>0?'colorBlack':'colorPlace'">{{ContentDetail || introducePlaceholder}}</p>
                <textarea
                v-else
                  class="ipt"
                  type="text"
