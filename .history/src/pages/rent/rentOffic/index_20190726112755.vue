        ...
        <div class="form-cells">
          ...
          <div class="form-cells-item">
            <div class="">
              ...
              <div class="form-cell-bd">
                <p class="ipt" style="height:200rpx!important;padding:20rpx" v-if="showp" @tap="showp=false" :class="Synopsis.length>0?'colorBlack':'colorPlace'">{{Synopsis ||  'introducePlaceholder'}}</p>
