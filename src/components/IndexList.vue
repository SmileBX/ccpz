<template>
  <div class="index-list">
      <scroll-view scroll-y="true" style="height:100vh" :scroll-into-view="scrollTopId" @scroll="onListWrapScroll" ref="indexWrap" :scroll-top="scrollTop" id="scroll">
        <!-- <ul class="index-list-wrap" ref="indexWrap" @scroll="onListWrapScroll"> -->
        <ul class="index-list-wrap">
          <li v-for="(group,nindex) in data" :key="nindex" class="index-group" ref="indexGroup" :data-title="group.title" :class="'itemClient'+(nindex*1)">
